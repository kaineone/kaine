...
- [ ] 3.1 Phase 1: slim base dependencies into extras; native Redis and Qdrant install paths; one installer for x86-64 and aarch64 that detects the target.
- [ ] 3.2 Phase 2: torch-free core backends (a NumPy CfC, one shared ONNX embedder, sherpa-onnx speech) and slip-driven automatic time dilation.
