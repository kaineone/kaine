# cl1-plugin Specification

## Purpose
How the CL1 package plugs into KAINE: the `cl1` entry point, the seams it declares for the chosen modules, and how it shares one substrate across them.
