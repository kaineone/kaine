...
## Purpose
The CL1 substrate that the plugin drives: how it reaches real hardware only through a welfare gate, and how stimulation stays tied to KAINE's cycle so that a frozen cycle delivers none.
