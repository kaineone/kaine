...
| **viz.js / `LevelMeter`** (ferrofluid speech/affect visualizer) | `kaine/nexus/static/vendor/viz.js` | GPL-3.0-or-later | https://www.gnu.org/licenses/gpl-3.0.html | Fieldtrip companion app — vendored verbatim with its SPDX header intact |
